...
public function generateShipment ($order_id)
{
    try
    {
        ...
        /*
        $shipment = $order->prepareShipment($this->getPdtOrderQty($order));
        $shipment->register();
        $order->setIsInProcess(true);
    ...
    {
        Mage::helper('push')->log('[Intelipost Generate Shipment] Erro: ' . $e->getMessage());
        return false;
    }
...
public function getPdtOrderQty($order)
{
    $itemQty = 1;
